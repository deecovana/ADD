...
@export var CENTER_OF_MASS = Vector3(0.0, 0.33,-0.14)
@export var CENTER_OF_AERO = Vector3(0.0, 0.40, 0.90)
...
var engine_index_up = [-1.0, 0.0, 1.0, 
	...
	225.0, 232.0, 240.0, 300.0, 300.0, 300.0]
var engine_index_down = [-1.0, 0.0, 1.0, 
	55.0, 95.0, 135.0, 165.0, 190.0, 210.0, 
	220.0, 230.0, 238.0, 299.0, 299.0, 299.0]
var eng_min_rpm = [         0.30, 0.20,
	0.30, 0.45, 0.55, 0.62, 0.68, 0.72, 
	0.74, 0.78, 0.80, 0.80, 0.80, 0.80]
