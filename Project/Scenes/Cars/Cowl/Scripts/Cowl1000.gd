...
@export var CENTER_OF_MASS = Vector3(0.0,0.33,0.44)
@export var CENTER_OF_AERO = Vector3(0.0,0.6,0.66)
...
@export var steer_control_speed = 0.9
@export var steer_restore_speed = 1.8
...
@export var max_force_front = 25500
@export var max_force_rear = 19500
