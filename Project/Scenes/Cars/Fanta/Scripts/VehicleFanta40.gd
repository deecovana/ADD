...
@export var vehicle_brake_force = 1.0
## Wheel3D braking force and balance
@export var wheel_brake_force = 0.8
...
@export var damp_compr_front = 6
## Rear ## 0.7 0.77
@export var damp_compr_rear = 4
## Front wheels damper relaxation ## 0.88
@export var damp_relax_front = 3
## Rear wheels damper relaxation ## 0.88
@export var damp_relax_rear = 2
...
@export var max_force_front = 3000
@export var max_force_rear = 2400
