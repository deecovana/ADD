...
@export var bodyDrag = 0.6 ## Need MORE max speed!!!

## !!!> RALLY verssion
## Setup AirDynamic Force
@export var bodyAeroDyn = 2.2
## Add Linear Friction
...
## 2. Short for 160 6th gear (Tri Proto acceleration)
#var engine_index_up = [
	#-1.0, 0.0, 1.0, 
	#50.0, 80.0, 110.0, 
	#130.0, 150.0, 170.0, 
...
var engine_index_up = [-1.0, 0.0, 1.0, 
	50.0, 100.0, 130.0, 160.0, 190.0, 220.0, 
	300.0, 300.0, 300.0, 300.0, 300.0, 300.0]
var engine_index_down = [-1.0, 0.0, 1.0, 
	40.0, 90.0, 125.0, 155.0, 185.0, 215.0, 
	299.0, 299.0, 299.0, 299.0, 299.0, 299.0]
...
#var engine_index_up = [-1.0, 0.0, 1.0, 
	 ...
	 #130.0, 140.0, 150.0, 300.0, 300.0]
#var engine_index_down = [-1.0, 0.0, 1.0, 
	 #35.0, 55.0, 75.0, 95.0, 115.0, 
	 #125.0, 135.0, 145.0, 300.0, 300.0]
#var eng_min_rpm = [    0.25, 0.0,
	 #0.40, 0.45, 0.49, 0.53, 0.56, 0.56, 
	 #0.68, 0.68, 1.00, 1.00]
