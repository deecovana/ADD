...
@export var CENTER_OF_MASS = Vector3(0.0,0.25,0.8)
...
@export var bodyLinearFricConst = 750.0 ## Rally
@export var bodyLinearFricLin = 7.5 ## Rally
...
@export var steer_control_speed = 1.6
...
#var eng_min_rpm = [         0.30, 0.0,
	...
	#0.70, 0.70, 0.70, 0.70, 0.70, 0.70]
# 3. Short for 160 6th gear (rally 2) Tested
var engine_index_up = [-1.0, 0.0, 1.0, 
